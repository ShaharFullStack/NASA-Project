...
export const fetchApodImage = async () => {
    const apiUrl = `https://api.nasa.gov/planetary/apod?api_key=AW4hXnRmahY72jSUGJYq0nzAFF62M4BF2oeScWLN`;
    try {
        ...
        if (data && data.url) {
            ...
            document.getElementById("picOfTheDay")?.setAttribute("alt", data.title);
        }
    }
    catch (error) {
